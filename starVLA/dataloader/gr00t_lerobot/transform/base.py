...
class ComposedModalityTransform(ModalityTransform):
    ...
    def set_metadata(
        ...
        current_metadata = dataset_metadata
        for transform in self.transforms:
            transform.set_metadata(current_metadata, original_metadata=original_metadata)
            current_metadata = transform.dataset_metadata
        self.dataset_metadata = current_metadata
