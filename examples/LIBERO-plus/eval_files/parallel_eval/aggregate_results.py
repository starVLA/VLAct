...
for category in overall_results:
    total_count = float(overall_results[category]['total_count'])
    overall_results[category]['success_rate'] = float(overall_results[category]['success_count']) / total_count if total_count else 0.0
