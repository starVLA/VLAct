...
const benchmarkData = {
  libero: {
    ...
    number: "82.6",
    suffix: "%",
    title: "Main-recipe result in the paper's LIBERO-Plus comparison",
    ...
    note: "Reported Total across seven perturbation axes; it is not a simple mean of rounded axis values",
    barsLabel: "Reported Total success rate (%)",
    decimals: 1,
    max: 100,
    bars: [
      ["VLAct", 82.6, true],
  ...
  vla: {
    ...
    description: "VLAct leads on safety, distractors, extrapolation, and long-horizon behavior, improving over π0.5 by 10.5 percentage points overall.",
  ...
  robotwin: {
    ...
    number: "92.5",
    suffix: "%",
    title: "Default VLAct-OFT result in the Data Scaling setting",
    description: "VLAct-OFT reaches 92.5% on Clean and 90.8% on Random evaluation. VLAct-PI records the paper's highest Clean result at 93.0%.",
    note: "Data Scaling uses 50 clean + 500 randomized trajectories per task; 50 tasks × 100 evaluation episodes",
    barsLabel: "Selected Data Scaling results · Clean success rate (%)",
    decimals: 1,
    max: 100,
    bars: [
      ["VLAct-PI", 93.0, false],
      ["VLAct-OFT", 92.5, true],
      ["HoloBrain-0-QW", 91.9, false],
      ["Fast-WAM", 91.9, false],
      ["Being-H0.7", 90.2, false],
    ],
  },
  domino: {
    ...
    number: "18.50",
    suffix: "% SR",
    title: "Best result in the paper's DOMINO comparison on both metrics",
  ...
  robocasa: {
    ...
    note: "Fine-tuned transfer · GR-1 trajectories absent from robot continued pre-training",
...
const realData = {
  short: {
    ...
    description: "Mean success across four in-domain single-arm tasks, compared with 77.5% for Qwen3VL-4B-OFT without VLA continued pre-training; 10 rollouts per task.",
    gain: "+15.0 pp",
  },
  novel: {
    number: "90.0%",
    title: "Objects change. The behavior holds.",
    description: "Separate averages for the novel-object-from-pot and novel-object-in-cup task families are both 90.0%; Qwen3VL-4B-OFT without VLA continued pre-training reaches 73.3% and 65.0%.",
    gain: "+16.7 / +25.0 pp",
  },
  long: {
    number: "86.6% / 80.0%",
    title: "Longer tasks retain their logic",
    description: "Stage-weighted completion rates for table cleaning and scooping beans, versus 73.3% and 33.3% for Qwen3VL-4B-OFT without VLA continued pre-training.",
    gain: "+13.3 / +46.7 pp",
  },
  dual: {
    number: "72.0%",
    title: "Transfer to dual-arm coordination",
    description: "Mean success across five real-world dual-arm Franka tasks, versus 44.0% for Qwen3VL-4B-OFT without VLA continued pre-training; 10 rollouts per task.",
    gain: "+28.0 pp",
  },
};
...
const rolloutData = {
  ...
  "table-baseline": {
    ...
    type: "Qwen3VL-4B-OFT without VLA continued pre-training",
